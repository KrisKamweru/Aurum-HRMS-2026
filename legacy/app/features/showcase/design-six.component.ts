import { ChangeDetectionStrategy, Component, signal, inject, ElementRef, afterNextRender } from '@angular/core';
...
@Component({
  ...
  styles: [`
    ...
    .checks li::before { content: '✓'; position: absolute; left: 0; color: var(--red); font-weight: 700; font-size: .7rem; }
