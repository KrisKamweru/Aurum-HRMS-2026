...
export class UiBadgeComponent {
  ...
  getClasses(): string {
    const base = 'inline-flex items-center font-semibold tracking-wide backdrop-blur-md shadow-sm';
    ...
    const variantMap: Record<BadgeVariant, string> = {
      ...
      neutral: 'bg-white/40 text-slate-800 ring-1 ring-black/5 dark:bg-white/5 dark:text-slate-300 dark:ring-white/10',
