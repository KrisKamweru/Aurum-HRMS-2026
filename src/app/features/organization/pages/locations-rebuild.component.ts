          ...
          <table class="min-w-full text-left">
            ...
            <tbody>
              @if (locationsLoading() && locations().length === 0) {
                <tr>
                  <td colspan="5" class="px-4 py-8 text-center text-sm text-stone-500 dark:text-stone-400">Loading locations...</td>
                </tr>
              }
              @for (location of locations(); track location.id) {
                ...
                @if (!locationsLoading()) {
                  <tr>
                    <td colspan="5" class="px-4 py-8 text-center text-sm text-stone-500 dark:text-stone-400">No locations found.</td>
                  </tr>
                }
              }
            </tbody>
