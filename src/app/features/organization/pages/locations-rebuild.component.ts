  ...
  template: `
    <main class="h-full px-4 py-8 sm:px-6 lg:px-8">
      <app-organization-list-shell
        title="Locations"
        description="Convex-backed site footprint setup with editable location metadata."
        actionMessage="Use step-based modal forms to capture location identity and address context."
      >
        ...
        <app-organization-list-toolbar-actions
          ...
          (refreshRequested)="refreshLocations()"
