  ...
  template: `
    <div class="space-y-6">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-3xl font-bold text-stone-900 dark:text-white tracking-tight">Resignations</h1>
          <p class="mt-2 text-[15px] text-stone-600 dark:text-stone-400">Manage employee resignations and exit process.</p>
        </div>
        <ui-button
          (onClick)="openCreateModal()"
          [prerequisitesMet]="employees().length > 0"
          prerequisiteMessage="You need to add employees before you can submit a resignation."
