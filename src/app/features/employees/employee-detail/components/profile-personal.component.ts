    ...
    <div class="space-y-4 sm:space-y-6">
      ...
      <div class="dash-frame">
        <ui-grid [columns]="'1fr'" [gap]="'0px'">
          <ui-grid-tile title="Emergency Contacts" variant="compact">
            <ui-button size="sm" variant="ghost" tile-actions (onClick)="openContactModal()">
              ...
              @if (contacts().length === 0) {
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  @for (contact of contacts(); track contact._id) {
                    <div class="p-4 rounded-xl border border-stone-200 dark:border-white/8 bg-stone-50/50 dark:bg-white/5 relative group">
